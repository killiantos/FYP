...
//Alfred
public class MyRobot2 extends Agent {
	...
	public MyRobot2 (Vector3d position, String name) {     
		super(position,name);
		...
		startX = position.x;
		startY = position.z;
		BufferedImage agentCamera = new BufferedImage(null, null, (Boolean) null, null);
		agentCamera = camera.createCompatibleImage();
	}
