...
public class Element_Node_TreeGP_Operator_Divide_Factory extends Element_Node_Factory {

	public Element_Node build(Individual __owner, ArrayList __operators) {
		return (Element_Node)(new Element_Node_TreeGP_Operator_Divide(__owner, __operators));
	}
