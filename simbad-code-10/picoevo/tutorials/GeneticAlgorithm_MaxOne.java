...
package picoevo.tutorials;

import picoevo.app.CoEvoModuleForMultiplexer.SelectionOperator_Koza92multiplexer;
import picoevo.core.*;
...
public class GeneticAlgorithm_MaxOne {
    public static void launchExampleOne_MaxOne_GAstyle()
    {
        ...
        // 200, 250,5,195,true,512,1.0/512.0
        ...
        parameterSet.setSelectionOperator(new SelectionOperator_Koza92multiplexer("Koza92multiplexer")); // testing
