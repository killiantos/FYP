...
public class EvaluationOperator_Individual_SymReg_Sinus extends EvaluationOperator_Individual_SymReg {

	// ### Constructors ###
	
	public EvaluationOperator_Individual_SymReg_Sinus () 
	{
		super();
	}
	
	public EvaluationOperator_Individual_SymReg_Sinus (String __name) 
	{ 
		super(__name); 
	}
	...
	public void evaluate(Object __o) 
	{
		...
		try {
			...
			for ( double i = 0 ; i < nbtry ; i++ )
			{
				...
				double testValue = Math.random()*2*Math.PI;
