...
public class Element_Node_TreeGP_Operator_rlog_Factory extends Element_Node_Factory {

	public Element_Node build(Individual __owner, ArrayList __operators) {
		return (Element_Node)(new Element_Node_TreeGP_Operator_rlog(__owner, __operators));
	}
